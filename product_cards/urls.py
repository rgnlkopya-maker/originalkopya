...
urlpatterns = [
    ...
    path("qr/paylasilan-foy/<str:token>/", guest_saved_views.public_draft_sheet, name="public_draft_sheet"),
    ...
    path("qr-kart/<int:card_id>/png/", public_qr_views.product_qr_png, name="product_qr_png"),
    path("qr-kart/<int:card_id>/indir/", public_qr_views.product_qr_download, name="product_qr_download"),
    path("qr-kart/<int:card_id>/etiket/", public_qr_views.product_qr_label, name="product_qr_label"),
