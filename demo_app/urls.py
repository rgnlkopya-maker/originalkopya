...
from core.consignment_views import consignment_list, consignment_add, consignment_use, consignment_send_order, consignment_return_order
from core.order_transfer_views import transfer_production_history, search_transfer_targets, order_by_number
from core.price_history_views import customer_product_price_history
from core.multi_order_views import order_multi_create
from core.persistent_order_image_views import order_edit_persistent, order_detail_persistent, delete_order_image_by_url
...
from core.team_views import employee_detail, user_management_view, preview_user, preview_user_exit, my_page
from core.audit_views import employee_audit_logs
...
from core.siparis_finans_report_views import siparis_finans_raporu, siparis_finans_foyleri, siparis_finans_foy_detay
...
urlpatterns = [
    path("notifications/", views.notification_list, name="notification_list"), path("benim-sayfam/", my_page, name="my_page"), path("admin/", admin.site.urls), path("login/", views.custom_login, name="login"), path("login/location-verify/", views.staff_login_location_verify, name="staff_login_location_verify"), path("mesai-sonrasi-konum/", views.staff_after_hours_location_gate, name="staff_after_hours_location_gate"), path("mesai-sonrasi-konum/dogrula/", views.staff_after_hours_location_verify, name="staff_after_hours_location_verify"), path("custom-login/", views.custom_login, name="custom_login"), path("logout/", logout_view, name="logout"),
    ...
    path("", enhanced_order_list, name="order_list"), path("order/new/", views.order_create, name="order_create"), path("order/<int:pk>/", order_detail_persistent, name="order_detail"), path("order/<int:pk>/edit/", order_edit_persistent, name="order_edit"), path("order/<int:pk>/delete-image-by-url/", delete_order_image_by_url, name="delete_order_image_by_url"),
    ...
    path("orders/<int:pk>/update/", views.update_stage, name="update_stage"), path("order/<int:pk>/delete/", views.order_delete, name="order_delete"), path("orders/<int:pk>/upload-image/", views.order_upload_image, name="order_upload_image"), path("orders/<int:pk>/add-image/", views.order_add_image, name="order_add_image"), path("images/<int:image_id>/delete/", views.delete_order_image, name="delete_order_image"), path("images/<int:image_id>/", views.view_image, name="view_image"), path("orders/multi-create/", order_multi_create, name="order_multi_create"), path("ajax/gecmis-fiyatlar/", customer_product_price_history, name="customer_product_price_history"),
    path("musteriler/", customer_list, name="customer_list"), path("musteriler/<int:customer_id>/duzenle/", customer_edit, name="customer_edit"), path("musteri/new/", views.musteri_create, name="musteri_create"), path("ajax/musteri/ekle/", musteri_ekle_veya_aktif_et, name="ajax_musteri_ekle"), path("ajax/musteri/pasif-yap/", views.musteri_pasif_yap_ajax, name="musteri_pasif_yap_ajax"), path("users/", user_management_view, name="user_management"), path("users/preview/exit/", preview_user_exit, name="preview_user_exit"), path("users/<int:user_id>/preview/", preview_user, name="preview_user"), path("users/<int:user_id>/", employee_detail, name="employee_detail"), path("users/<int:user_id>/islem-kayitlari/", employee_audit_logs, name="employee_audit_logs"),
    path("reports/", views.reports_view, name="reports"), path("staff-reports/", views.staff_reports_view, name="staff_reports"), path("reports/giden-urunler/", views.giden_urunler_raporu, name="giden_urunler_raporu"), path("reports/home/", views.reports_home, name="reports_home"), path("reports/fasoncu/", fasoncu_raporu, name="fasoncu_raporu"), path("reports/fasoncu/<int:fasoncu_id>/", fasoncu_detay, name="fasoncu_detay"), path("reports/nakisci/", nakisci_raporu, name="nakisci_raporu"), path("reports/nakisci/<int:nakisci_id>/", nakisci_detay, name="nakisci_detay"), path("reports/musteri-karsilastirma/", customer_comparison_report, name="customer_comparison_report"), path("reports/musteri-karsilastirma/<int:customer_id>/", customer_detail_report, name="customer_detail_report"), path("reports/musteri-karsilastirma/<int:customer_id>/konsinye/", customer_consignment_partial, name="customer_consignment_partial"),
    path("reports/siparis-finans/", siparis_finans_raporu, name="siparis_finans_raporu"), path("reports/siparis-finans/foyler/", siparis_finans_foyleri, name="siparis_finans_foyleri"), path("reports/siparis-finans/foyler/<int:draft_id>/", siparis_finans_foy_detay, name="siparis_finans_foy_detay"),
