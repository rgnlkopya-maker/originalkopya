...
from core.team_views import employee_detail, user_management_view, preview_user, preview_user_exit
...
urlpatterns = [
    path("notifications/", views.notification_list, name="notification_list"), path("admin/", admin.site.urls), path("login/", views.custom_login, name="login"), path("login/location-verify/", views.staff_login_location_verify, name="staff_login_location_verify"), path("login/mesai-konum/", views.staff_session_location_gate, name="staff_session_location_gate"), path("login/mesai-konum/dogrula/", views.staff_session_location_verify, name="staff_session_location_verify"), path("custom-login/", views.custom_login, name="custom_login"), path("logout/", logout_view, name="logout"),
