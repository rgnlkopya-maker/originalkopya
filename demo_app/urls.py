...
urlpatterns = [
    ...
    path("order/<int:source_order_id>/production-transfer/", transfer_production_history, name="transfer_production_history"), path("order/<int:source_order_id>/production-transfer/search/", search_transfer_targets, name="transfer_production_history_search"), path("order-no/<str:order_number>/", order_by_number, name="order_by_number"),
