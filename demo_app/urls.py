...
urlpatterns = [
    ...
    path("reports/", views.reports_view, name="reports"), path("staff-reports/", views.staff_reports_view, name="staff_reports"), path("reports/giden-urunler/", views.giden_urunler_raporu, name="giden_urunler_raporu"), path("reports/home/", views.reports_home, name="reports_home"), path("reports/fasoncu/", fasoncu_raporu, name="fasoncu_raporu"), path("reports/fasoncu/<int:fasoncu_id>/", fasoncu_detay, name="fasoncu_detay"), path("reports/nakisci/", views.nakisci_raporu, name="nakisci_raporu"), path("reports/nakisci/<int:nakisci_id>/", nakisci_detay, name="nakisci_detay"), path("reports/musteri-karsilastirma/", customer_comparison_report, name="customer_comparison_report"), path("reports/musteri-karsilastirma/<int:customer_id>/", customer_detail_report, name="customer_detail_report"),
