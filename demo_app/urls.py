...
from core.persistent_order_image_views import order_edit_persistent, order_detail_persistent
...
urlpatterns = [
    ...
    path("", enhanced_order_list, name="order_list"), path("order/new/", views.order_create, name="order_create"), path("order/<int:pk>/", order_detail_persistent, name="order_detail"), path("order/<int:pk>/edit/", order_edit_persistent, name="order_edit"),
